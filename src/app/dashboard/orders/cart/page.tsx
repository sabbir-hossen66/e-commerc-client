  ...
  const handleCheckout = async () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        clearCart(); // call your clear function
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 sticky top-4 lg:top-6">
            ...
            <button
              ...
              className={`w-full py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-bold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 ${
                isProcessing
